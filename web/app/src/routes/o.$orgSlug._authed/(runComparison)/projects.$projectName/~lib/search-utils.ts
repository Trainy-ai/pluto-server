...
import type { Widget, ChartWidgetConfig, ScatterWidgetConfig, SingleValueWidgetConfig, HistogramWidgetConfig, FileSeriesWidgetConfig, LogsWidgetConfig } from "../~types/dashboard-types";
